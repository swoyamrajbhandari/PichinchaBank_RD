...
|FR~9.1|The Customer shall be able to sort their contacts by date added.|Given that the customer wants to sort their contacts by date added, when the customer chooses the option to sort their contact list by "date added", they will sort their contacts by date added.||
|FR~9.2|The Customer shall be able to sort their contacts alphabetically.|Given that the customer wants to sort their contacts alphabetically, when the customer chooses the option to sort their contact list by "name", they will sort their contacts alphabetically.||
